...
impl BreakoutState {
    ...
    pub fn new() -> BreakoutState {
        ...
        let offset = Vec2D::new(screen::BOARD_LEFT_X.into(), (screen::BOARD_TOP_Y + screen::ROOF_SPACING).into());
    ...
    pub fn draw(&self) -> Vec<Drawable> {
        ...
        output.push(Drawable::rect(
            ...
            0, screen::FRAME_OFFSET + screen::FRAME_LEFT_HEIGHT - screen::FRAME_LEFT_SUPPORT.1,
            screen::FRAME_LEFT_SUPPORT.0, screen::FRAME_LEFT_SUPPORT.1
        ));
        
        // Draw frame right:
        output.push(Drawable::rect(
            (&screen::FRAME_COLOR).into(),
            screen::BOARD_RIGHT_X, screen::FRAME_OFFSET,
            screen::FRAME_SUPPORT_WIDTH,
        ...
        output.push(Drawable::rect(
            ...
            screen::FRAME_RIGHT_SUPPORT.0, screen::FRAME_RIGHT_SUPPORT.1
        ));
